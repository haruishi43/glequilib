...
from OpenGL.GL.EXT.framebuffer_object import * #For `glGenerateMipmapsEXT(...)`, if necessary
...
class Texture2D(object):
    ...
    def set_nicest(self):
        ...
        except: # I don't know why this is necessary, but it happens on some systems.
